...
const ProjectDescription = (props:Props) => {
    ...
    return (
        <div className={`flex above flex-col space-y-4 w-full tm:w-[40%] justify-start ${even ? '' : 'items-start tm:items-end'}`}>
            ...
            <div className={`tm:absolute w-full tm:w-[50%]  flex flex-col top-[20%] space-y-5  bg-opacity-25 ${even ? '' : 'items-start tm:items-end'}`}>
