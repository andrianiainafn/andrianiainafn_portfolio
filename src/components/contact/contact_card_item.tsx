...
const ContactCardItem = (props:Props) => {
    const {contact} = props
    return (
        <div className="  flex flex-col  space-y-2 relative  p-2">
            ...
            <div className="above flex backdrop-filter flex-col space-y-3 backdrop-blur-[2px] blurText bg-white/5 rounded-lg  p-2">
                {contact.icon}
