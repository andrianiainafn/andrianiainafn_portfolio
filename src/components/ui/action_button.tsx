...
const ActionButton = (props: Props) => {
  if (props.iconOnly) {
    return (
      <button className="group cursor-pointer border font-medium relative border-gray-300 dark:border-white/20 hover:border-blue-500/60 text-gray-900 dark:text-white p-2.5 h-[38px] w-[38px] rounded-full bg-gray-100/80 dark:bg-white/5 hover:bg-gray-200/80 dark:hover:bg-white/10 backdrop-blur-sm transition-all duration-300 flex items-center justify-center overflow-hidden">
        <span className="transition duration-300 group-hover:scale-110 group-hover:text-blue-500">
          {props.icon}
        </span>
